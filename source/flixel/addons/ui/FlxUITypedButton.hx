...
function getToggleStatusAnimation(status:Int):FlxButtonState
{
    switch (status)
    {
        case 0:
            return FlxButtonState.NORMAL;
        case 1:
            return FlxButtonState.HIGHLIGHT;
        // Add more cases as needed to map your integer status values
        default:
            return FlxButtonState.NORMAL; // Or handle unexpected status
    }
}
